      ...
      <div class="doc-list">
        <a class="doc-item" :href="'#/clinic/' + doc.rid" v-for="doc in doclist">
          ...
          <div class="doc-info">
            ...
            <div class="freebtn">
              <img src="../assets/tag_mianfeizixuncopy@2x.png" alt="" v-if="doc.remaintime !== '抢光了'">
...
<style lang="less">
  #freedoclist{
    ...
    .doc-item .doc-info{flex: 1;border-bottom:1px solid #e9e9e9;position: relative;padding-bottom: .06rem;}
    ...
    .doc-item .doc-info .freebtn img.none{width: 1.1rem;}
