...
<style lang="less">
  ...
  *{margin: 0;padding: 0}
  ...
  .weui-toast .weui-loading{animation:move .5s steps(6) infinite;animation-timing-function : step-start;
    background: transparent url("./assets/loading_icon_logo@2x.png") no-repeat;background-size: cover;width: .42rem;height: .42rem;margin-left: -.21rem;}
